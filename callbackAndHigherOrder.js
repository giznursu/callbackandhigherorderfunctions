...
// CODE HERE
const multiply = (num1,num2,callfunction) => {
  return callfunction(num1,num2)
}

const callfunction = (num1,num2) => {
  return num1*num2
}
...
answer = multiply(4, 3,callfunction) 
...
firstName = first(names, callback)
...
const lastName = (arr) => arr[arr.length-1]

// UNCOMMENT THE FUNCTION CALL BELOW
// RUN THIS FILE WITH NODE
// CHECK YOUR ANSWER

callFunc  = last(names, lastName) 
console.log('The last name in names is ' + callFunc)
...
// CODE HERE 
const contains = (arr,name,callbackk) => {
  return callbackk(arr,name)
}
const callbackk = (arr,name) => arr.includes(name)
console.log(contains(names,"Colt",callbackk))
...
uniq(names, arr => console.log(`The new names array with all the duplicate items removed is ${arr}`))
...
// const function6 = (item,index) => {
//   return ` ${item} ${index}`
// }
// console.log(each(names,function6))
/*
